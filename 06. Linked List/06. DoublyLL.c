...
/*
The doubly linked list : 3 8 7 2 5
The reversed doubly linked list : 5 2 7 8 3
Number of nodes = 5

Enter the position (1 to 6) and value to insert : 2 6
The doubly linked list : 5 6 2 7 8 3

Enter the position (1 to 6) to delete : 4
Deleted value : 7
The doubly linked list : 5 6 2 8 3

Displaying the list in reverse order : 3 8 2 6 5
*/

...
5. To store user defined data types, we have to provide compare() function in order to store
...
int main()
{
    ...
    multiset <int> mst = {1, 2, 5, 4, 3, 2, 4, 1, 3, 5}; //default order of sorting is less
    for(auto& x : mst){
        cout << x << " ";
    }
    return 0;
